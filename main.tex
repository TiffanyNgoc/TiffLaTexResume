...
% }
\cvEntryPersonalNTD{Tele-Medi [https://github.com/TiffanyNgoc/UCM-Hackathon-2024]}{March 2024}{
   \cvItemS{HTML, CSS, JavaScript}
   \cvItem{Solo creation of Telemedicine website during HackMerced IX (2024) within 36 hours}
   \cvItem{Integrated video chat using WebRTC technology via HTML, CSS, and JavaScript}
   \cvItem{Developed AI Chatbot for enhanced user engagement and support}
   \cvItem{Aimed to bridge healthcare gaps, focusing on underserved communities}
   \cvItem{Demonstrated dedication to leveraging technology for social impact}
}
...
\cvEntryND{
    ...
    \cvItemND{Programming Languages}{Python (beginner), JavaScript (beginner), C++ (intermediate)}
